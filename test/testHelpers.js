...
const encodeForAtomic = (destAdress, weiValue, data) => {
  let encoder = new ethers.utils.AbiCoder();
  const types = ["address", "uint256", "bytes"]; // to, value, data
  return encoder.encode(types, [destAdress, weiValue, data]).slice(2);
};
...
const atomicBytecode =
  "";
...
module.exports = {
  ...
  encodeForAtomic: encdodeForAtomic,
};
