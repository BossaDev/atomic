...
async function runScriptWithBuidler(buidlerArguments, scriptPath, scriptArgs = [], extraNodeArgs = [], extraEnvVars = {}) {
    ...
    return runScript(scriptPath, scriptArgs, [...extraNodeArgs, "--require", buidlerRegisterPath], Object.assign({}, env_variables_1.getEnvVariablesMap(buidlerArguments), extraEnvVars));
}
