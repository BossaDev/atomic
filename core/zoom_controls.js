 ...
 * @private
 */
Blockly.ZoomControls.prototype.HEIGHT_ = 164;
 ...
 * @private
 */
Blockly.ZoomControls.prototype.createLaunchSvg_ = function () {
  /* This markup will be generated and added to the "blocklyZoom" group:
    <image width="36" height="36" y="88" xlink:href="../media/zoom-reset.svg">
    </image>
  */
   ...
   * @type {SVGElement}
   */
  var launchSvg = Blockly.utils.createSvgElement(
    'image', {
      'width': this.WIDTH_,
      'height': this.WIDTH_,
      'y': 0
  ...
  launchSvg.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href',
    ws.options.pathToMedia + this.ZOOM_RESET_PATH_);

  // Attach event listeners.
  Blockly.bindEventWithChecks_(launchSvg, 'mousedown', null, function (e) {

    console.log(xmlToJson(Blockly.Xml.workspaceToDom(ws)))
    Blockly.Touch.clearTouchIdentifier(); // Don't block future drags.
    e.preventDefault(); // Stop double-clicking from selecting text.
  });
};
